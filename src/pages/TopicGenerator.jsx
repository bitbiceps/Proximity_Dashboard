    ...
    <div className="min-h-screen  flex flex-col items-center py-8">
      ...
      <div className="w-full max-w-3xl p-6 ">
        ...
        <div className="flex justify-between items-center mt-6 px-40 mt-16">
         <Link to="/popup_search"> <button className="px-4 py-2  border border-[#00CDE2] rounded-lg hover:bg-blue-50">
            Have Another Suggestion
          </button></Link>
         <Link to="/generated_article"> <button className="px-8 py-2 text-white bg-[#4D49F6] rounded-lg hover:bg-blue-600">
            Submit
          </button></Link>
        </div>
      </div>
